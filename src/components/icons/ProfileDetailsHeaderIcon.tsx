const ProfileDetailsHeaderIcon = ({
  currentColour,
}: {
  currentColour: "fill-grey" | "fill-purple";
}) => {
  return (
    <svg
    ...
    >
      <path
        className={`group-hover:fill-purple ${currentColour}`}
...
export default ProfileDetailsHeaderIcon;
